...
const Footer = () => {
    return (
        <div className="bg-gradient-to-b from-gray-900 to-black text-white">
            <div className="flex flex-col items-center justify-center text-center sm:px-12 px-4 bg-gradient-to-r from-blue-600 to-blue-700 py-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:px-12 px-4 py-16">
                <div className="text-center sm:text-start">
                    <div className="flex items-center justify-center sm:justify-start mb-4">
                        <h2 className="text-3xl font-bold text-blue-400">eShop</h2>
                    </div>
                    ...
                    <div className="flex items-center justify-center sm:justify-start space-x-4">
                        <div className="p-2 bg-blue-600 rounded-full hover:bg-blue-500 transition-colors cursor-pointer">
                ...
                <div className="text-center sm:text-start">
                    <h3 className="text-xl font-semibold text-blue-400 mb-4">Company</h3>
                    <ul className="space-y-2">
                        {footerProductLinks.map((link, index) => (
                            <li key={index}>
                                <Link
                                    className="text-gray-300 hover:text-blue-400 duration-300 text-sm cursor-pointer leading-6 transition-colors"
                                    to={link.link}
                                >
                                    {link.name}
                                </Link>
                ...
                <div className="text-center sm:text-start">
                    <h3 className="text-xl font-semibold text-blue-400 mb-4">Shop</h3>
                    <ul className="space-y-2">
