...
const Header = ({ activeHeading }) => {
    ...
    return (
            ...
            >
                ...
                >
                    ...
                    <div className="flex">
                        <div className={`${styles.noramlFlex}`}>
                            <div
                                className="relative cursor-pointer mr-[15px] hover:bg-blue-500 p-2 rounded-lg transition-colors"
                        ...
                        <div className={`${styles.noramlFlex}`}>
                            <div className="relative cursor-pointer mr-[15px] hover:bg-blue-500 p-2 rounded-lg transition-colors">
                                {isAuthenticated ? (
                                    <Link to="/profile">
                                        <img
                                            src={getImageUrl(user?.avatar)}
                                            className="w-[35px] h-[35px] rounded-full border-2 border-blue-400"
                                            alt=""
                                        />
                                    </Link>
                                ) : (
      ...
      w-full h-[70px] bg-gradient-to-r from-blue-600 to-blue-700 z-50 top-0 left-0 shadow-sm 800px:hidden`}
            >
                ...
                {open && (
                    ...
                    >
                        <div className="fixed w-[70%] bg-white h-screen top-0 left-0 z-10 overflow-y-scroll">
                            <div className="w-full justify-between flex pr-3 bg-blue-600 py-4">
                                <div className="flex items-center">
                                    <div
                                    ...
                                    <h2 className="text-white text-lg font-semibold">eShop</h2>
                                </div>
                                <RxCross1
                                    size={30}
                            ...
                            <div className="my-8 w-[92%] m-auto h-[40px] relative">
                                <input
                                    type="search"
                                    placeholder="Search Product..."
                                    className="h-[45px] w-full px-4 border-[2px] border-blue-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    value={searchTerm}
                                    onChange={handleSearchChange}
                                />
                                <AiOutlineSearch
                                ...
                                />
                                {searchData && (
                                    <div className="absolute bg-white z-10 shadow-lg w-full left-0 p-3 rounded-lg border border-blue-200 mt-1">
                                        {searchData.map((i, index) => {
                                            const d = i.name;
                                            const Product_name = d.replace(/\s+/g, "-");
                                            return (
                                                <Link to={`/product/${Product_name}`} key={index}>
                                                    <div className="flex items-center py-2 hover:bg-blue-50 rounded px-2">
                                                        <img
                                                            src={getImageUrl(i.images[0])}
                                                            alt=""
                            ...
                            <Navbar active={activeHeading} />
                            <div className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 ml-4 px-4 py-3 rounded-lg shadow-lg transition-all duration-300 mr-4">
                                <Link to="/shop-create">
                                    <h1 className="text-white flex items-center font-semibold">
