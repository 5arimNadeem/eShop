...
const FALLBACK_IMAGE =
    "https://s.yimg.com/ny/api/res/1.2/SQRBWN_jTi9OvHKfqj9zbw--/YXBwaWQ9aGlnaGxhbmRlcjt3PTI4ODA7aD0xODU2O3E9NTA7Y2Y9d2VicA--/https://s.yimg.com/os/creatr-uploaded-images/2024-11/ac6669e0-9c7e-11ef-bffb-b5cce5d36e6a";
    ...
    return (
        <div className="relative w-full min-h-[600px] bg-white overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-30">
                ...
                <div className="absolute bottom-40 left-1/4 w-20 h-20 bg-blue-100 rounded-full blur-xl"></div>
            ...
            <div className={`${styles.section} w-[90%] 800px:w-[85%] flex flex-col 800px:flex-row items-center justify-between pt-16 pb-16 800px:pt-[210px] 800px:pb-20 relative z-10`}>
                ...
                <div className="w-full 800px:w-1/2 text-gray-800 mb-12 800px:mb-0">
                    ...
                    <h1 className="text-[40px] leading-[1.1] 800px:text-[64px] font-[800] capitalize mb-6">
                        Discover Amazing
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-blue-700"> Products</span>
                        <br />
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <Link to="/products" className="inline-block">
                            <div className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 px-8 py-4 rounded-lg shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl">
                        ...
                        <Link to="/products" className="inline-block">
                            <div className="border-2 border-blue-500 text-blue-600 hover:bg-blue-500 hover:text-white px-8 py-4 rounded-lg transition-all duration-300">
                ...
                <div className="w-full 800px:w-1/2 flex justify-center relative">
                    <div className="relative">
                        ...
                        <div className="absolute -top-8 -right-8 w-32 h-32 bg-blue-100 rounded-3xl rotate-12 opacity-60"></div>
                        <div className="absolute -bottom-8 -left-8 w-40 h-40 bg-blue-50 rounded-full -rotate-6 opacity-40"></div>
                        <div className="absolute top-1/2 -right-12 w-16 h-16 bg-blue-200 rounded-2xl rotate-45 opacity-50"></div>
                        ...
                        <div className="relative bg-white rounded-3xl shadow-2xl p-8 max-w-[600px] w-full border border-gray-100 transform hover:scale-105 transition-transform duration-300">
                            <div className="absolute inset-0 bg-gradient-to-br from-blue-50/10 to-blue-50/10 rounded-3xl"></div>
                            ...
                            {/* Enhanced badge */}
                            <div className="absolute -top-4 -right-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-3 rounded-full text-sm font-bold shadow-xl transform rotate-12">
                                ✨ Featured
                            </div>

                            {/* Quality badge */}
                            <div className="absolute -bottom-4 -left-4 bg-white text-blue-600 px-4 py-2 rounded-full text-sm font-semibold shadow-lg border-2 border-blue-100">
                                Premium Quality
                            </div>
                        </div>
                    </div>
