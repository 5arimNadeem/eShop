        ...
        <div className="w-full  h-[90vh] bg-white shadow-sm overflow-y-scroll sticky top-0 left-0 z-10">
            ...
            <div className="w-full flex items-center p-4">
                <Link to="/dashboard-products" className="w-full flex items-center">
                    ...
                    <h5 className={`hidden md:block pl-2 text-[18px] font-[400] ${active === 3 ? "text-[blue]" : "text-[#555]"}`}>
                        All Products
                    </h5>
                </Link>
            </div>
            ...
            <div className="w-full flex items-center p-4">
                <Link to="/dashboard-create-product" className="w-full flex items-center">
                    ...
                    <h5 className={`hidden md:block pl-2 text-[18px] font-[400] ${active === 4 ? "text-[blue]" : "text-[#555]"}`}>
                        Create Product
                    </h5>
                </Link>
            </div>
            ...
            <div className="w-full flex items-center p-4">
                <Link to="/dashboard-events" className="w-full flex items-center">
                    ...
                    <h5 className={`hidden md:block pl-2 text-[18px] font-[400] ${active === 5 ? "text-[blue]" : "text-[#555]"}`}>
                        All Events
                    </h5>
                </Link>
            </div>
            ...
            <div className="w-full flex items-center p-4">
                <Link to="/dashboard-create-event" className="w-full flex items-center">
                    ...
                    <h5 className={`hidden md:block pl-2 text-[18px] font-[400] ${active === 6 ? "text-[blue]" : "text-[#555]"}`}>
                        Create Event
                    </h5>
                </Link>
            </div>
            ...
            <div className="w-full flex items-center p-4">
                <Link to="/dashboard-withdraw-money" className="w-full flex items-center">
                    ...
                    <h5 className={`hidden md:block pl-2 text-[18px] font-[400] ${active === 7 ? "text-[blue]" : "text-[#555]"}`}>
                        Withdraw Money
                    </h5>
                </Link>
            </div>
            ...
            <div className="w-full flex items-center p-4">
                <Link to="/dashboard-messages" className="w-full flex items-center">
                    ...
                    <h5 className={`hidden md:block pl-2 text-[18px] font-[400] ${active === 8 ? "text-[blue]" : "text-[#555]"}`}>
                        Shop Inbox
                    </h5>
                </Link>
            </div>
            ...
            <div className="w-full flex items-center p-4">
                <Link to="/dashboard-coupons" className="w-full flex items-center">
                    ...
                    <h5 className={`hidden md:block pl-2 text-[18px] font-[400] ${active === 9 ? "text-[blue]" : "text-[#555]"}`}>
                        Discount Codes
                    </h5>
                </Link>
            </div>
            ...
            <div className="w-full flex items-center p-4">
                <Link to="/dashboard-refunds" className="w-full flex items-center">
                    ...
                    <h5 className={`hidden md:block pl-2 text-[18px] font-[400] ${active === 10 ? "text-[blue]" : "text-[#555]"}`}>
                        Refunds
                    </h5>
                </Link>
            </div>
            ...
            <div className="w-full flex items-center p-4">
                <Link to="/settings" className="w-full flex items-center">
                    ...
                    <h5 className={`hidden md:block pl-2 text-[18px] font-[400] ${active === 11 ? "text-[blue]" : "text-[#555]"}`}>
                        Settings
                    </h5>
                </Link>
            </div>
