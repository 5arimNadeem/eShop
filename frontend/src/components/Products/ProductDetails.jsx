...
const ProductDetails = ({ data, isEvent }) => {
    ...
    // Normalize images: API products use data.images (filenames)
    // Static data uses data.image_Url (array of {url} objects)
    // Produce a single array so the rest of the component works the same
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex gap-3 overflow-x-auto pb-2">
                                    {images.map((image, index) => (
                                        <div
                                            key={index}
                                            className={`relative flex-shrink-0 cursor-pointer rounded-lg overflow-hidden transition-all duration-200 ${select === index
                            ...
                            <div className="space-y-8">
                                <div className="bg-white rounded-2xl shadow-lg p-8 border border-blue-100">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className={`flex items-end gap-4 py-4 ${isEvent ? 'bg-gradient-to-r from-red-50 to-orange-50 rounded-lg p-4 border-l-4 border-orange-400' : ''}`}>
                                            ...
                                            <span className={`text-4xl font-bold ${isEvent ? 'text-red-600' : 'text-blue-600'}`}>
                                                ${data.discountPrice}
                                            </span>
                                            ...
                                            {data.originalPrice && data.originalPrice !== data.discountPrice && (
                                                <span className={`${isEvent ? 'bg-red-100 text-red-800' : 'bg-blue-100 text-blue-800'} text-sm font-medium px-3 py-1 rounded-full`}>
                                    ...
                                    <div className="flex items-center justify-between py-6 border-t border-gray-100">
                                        <div className="flex items-center space-x-4">
                                            ...
                                            <div className="flex items-center bg-gray-100 rounded-xl overflow-hidden">
                                                <button
                                                    className="p-3 hover:bg-blue-100 transition-colors duration-200 flex items-center justify-center"
                                        ...
                                        <button
                                            className={`p-3 rounded-full transition-all duration-200 ${click
                                    ...
                                    {/* Add to Cart Button */}
                                    <button
                                        className="w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold py-4 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center space-x-3"
                                ...
                                <div className="bg-white rounded-2xl shadow-lg p-6 border border-blue-100">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-4">
                                            <Link to={`/shop/preview/${data?.shop._id}`}>
                                                <img
                                                    ...
                                                    alt={data.shop.name}
                                                    className="w-16 h-16 rounded-full object-cover border-3 border-blue-200 hover:border-blue-400 transition-colors duration-200"
                                                />
                                            </Link>
                                            <div>
                                                <Link to={`/shop/preview/${data?.shop._id}`}>
                                        ...
                                        <button
                                            className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 flex items-center space-x-2"
    ...
    return (
        <div className="bg-white rounded-2xl shadow-lg border border-blue-100 overflow-hidden">
            ...
            <div className="flex border-b border-gray-200">
                <button
                    className={`flex-1 px-6 py-4 text-center font-semibold transition-all duration-200 ${active === 1
                ...
                <button
                    className={`flex-1 px-6 py-4 text-center font-semibold transition-all duration-200 ${active === 2
                        ? "bg-gradient-to-r from-blue-500 to-blue-600 text-white"
                        : "text-gray-600 hover:text-blue-600 hover:bg-blue-50"
                        }`}
                    onClick={() => setActive(2)}
                ...
                <button
                    className={`flex-1 px-6 py-4 text-center font-semibold transition-all duration-200 ${active === 3
                        ? "bg-gradient-to-r from-blue-500 to-blue-600 text-white"
                        : "text-gray-600 hover:text-blue-600 hover:bg-blue-50"
                        }`}
                    onClick={() => setActive(3)}
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                            <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                                <h4 className="font-semibold text-blue-800 mb-2">Product Details</h4>
                ...
                {active === 3 && (
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-6">
                                <Link to={`/shop/preview/${data.shop._id}`}>
                                    <div className="bg-blue-50 rounded-xl p-6 border border-blue-200 hover:border-blue-300 transition-colors duration-200">
                                        <div className="flex items-center space-x-4 mb-4">
                                            ...
                                            />
                                            <div>
                                                <h3 className="text-xl font-bold text-blue-800">{data.shop.name}</h3>
                                                <div className="flex items-center space-x-2">
                                                    <Ratings rating={averageRating} />
                                        ...
                                        <p className="text-blue-700 leading-relaxed">{data.shop.description}</p>
                                    </div>
                                </Link>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <Link to={`/shop/preview/${data?.shop._id}`}>
                                    <button className="w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200">
                                        Visit Shop
                                    </button>
                                </Link>
                            </div>
